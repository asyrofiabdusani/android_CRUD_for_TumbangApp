...
public class Bahasa36 extends AppCompatActivity {
    ...
    private void listItem() {
        list.add(new StimulasiList("","Stimulasi Yang Perlu Dilanjutkan",
                getString(R.string.lanjutkan36bb)));
        list.add(new StimulasiList("Berbicara Dengan Anak","",
                getString(R.string.berbicara_dengan_anak)));
        list.add(new StimulasiList("Bercerita Mengenai Dirinya","",
                getString(R.string.bercerita_tentang_dirinya)));
        list.add(new StimulasiList("Album Fotoku","",
                getString(R.string.album_fotoku)));
        list.add(new StimulasiList("Mengenal Huruf","",
                getString(R.string.mengenal_huruf)));
    }

...
public class Halus12 extends AppCompatActivity {
    ...
    private void listItem() {
        list.add(new StimulasiList("","Stimulasi Yang Perlu Dilanjutkan",
                getString(R.string.lanjutkan12h)));
        list.add(new StimulasiList("Permainan Balok","",
                getString(R.string.permainan_balok)));
        list.add(new StimulasiList("Memasukkan dan Mengeluarkan Benda","",
                getString(R.string.memasukkan_dan_mengeluarkan_benda)));
        list.add(new StimulasiList("Memasukkan Benda Yang Satu Ke Benda Yang Lainnya",
                "", getString(R.string.memasukkan_benda_yang_satu_dengan_yang_lain)));
    }

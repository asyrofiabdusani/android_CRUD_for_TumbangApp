...
public class Kasar24 extends AppCompatActivity {
    ...
    private void listItem() {
        list.add(new StimulasiList("","Stimulasi Yang Perlu Dilanjutkan",
                getString(R.string.lanjutkan24k)));
        list.add(new StimulasiList("Latihan Menghadapi Rintangan","",
                getString(R.string.latihan_mengahadapi_rintangan)));
        list.add(new StimulasiList("Melompat Jauh","",getString(R.string.melompat_jauh)));
        list.add(new StimulasiList("Melempar dan Menangkap","", getString(R.string.melempar_menangkap)));
    }
    @Override

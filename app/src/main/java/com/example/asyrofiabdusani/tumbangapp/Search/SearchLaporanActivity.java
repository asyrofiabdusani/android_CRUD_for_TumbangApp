...
import com.example.asyrofiabdusani.tumbangapp.Laporan.LaporanPertumbuhanList;
import com.example.asyrofiabdusani.tumbangapp.R;

public class SearchLaporanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SearchLaporanActivity.this, LaporanPertumbuhanList.class);

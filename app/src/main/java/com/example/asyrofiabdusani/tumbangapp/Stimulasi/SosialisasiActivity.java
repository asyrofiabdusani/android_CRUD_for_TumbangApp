...
public class SosialisasiActivity extends AppCompatActivity {
    ...
    private void listItem() {
        list.add(new ListStimulus("9 - 12","Stimulasi Umur 9 - 12 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Sosialisasi.Sosialisasi9"));
        list.add(new ListStimulus("12 - 15","Stimulasi Umur 12 - 15 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Sosialisasi.Sosialisasi12"));
        list.add(new ListStimulus("15 - 18","Stimulasi Umur 15 - 18 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Sosialisasi.Sosialisasi15"));
        list.add(new ListStimulus("18 - 24","Stimulasi Umur 18 - 24 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Sosialisasi.Sosialisasi18"));
        list.add(new ListStimulus("24 - 36","Stimulasi Umur 24 - 36 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Sosialisasi.Sosialisasi24"));
        list.add(new ListStimulus("36 - 48","Stimulasi Umur 36 - 48 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Sosialisasi.Sosialisasi36"));
        list.add(new ListStimulus("48 - 60","Stimulasi Umur 48 - 60 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Sosialisasi.Sosialisasi48"));
        list.add(new ListStimulus("60 - 72","Stimulasi Umur 60 - 72 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Sosialisasi.Sosialisasi60"));
    }

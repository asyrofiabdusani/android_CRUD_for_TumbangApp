...
public class Bahasa12 extends AppCompatActivity {
    ...
    private void listItem() {
        list.add(new StimulasiList("","Stimulasi Yang Perlu Dilanjutkan",getString(R.string.lanjutkan12bb)));
        list.add(new StimulasiList("Membuat Suara","",getString(R.string.membuat_suara)));
        list.add(new StimulasiList("Menyebut Nama Bagian Tubuh","",getString(R.string.menyebut_nama_bagian_tubuh)));
        list.add(new StimulasiList("Pembicaraan","", getString(R.string.pembicaraan)));
    }

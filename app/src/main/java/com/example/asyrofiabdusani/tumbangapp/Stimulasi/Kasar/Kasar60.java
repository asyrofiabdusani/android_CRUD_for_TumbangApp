...
public class Kasar60 extends AppCompatActivity {
    ...
    private void listItem() {
        list.add(new StimulasiList("","Stimulasi Yang Perlu Dilanjutkan",
                getString(R.string.lanjutkan60k)));
        list.add(new StimulasiList("Naik Sepeda, Bermain Sepatu Roda","",
                getString(R.string.naik_sepeda_bermain_sepatu_roda)));
    }
    @Override

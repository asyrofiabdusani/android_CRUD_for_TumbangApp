...
public class BahasaActivity extends AppCompatActivity {
    ...
    private void listItem() {
        list.add(new ListStimulus("9 - 12","Stimulasi Umur 9 - 12 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Bahasa.Bahasa9"));
        list.add(new ListStimulus("12 - 15","Stimulasi Umur 12 - 15 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Bahasa.Bahasa12"));
        list.add(new ListStimulus("15 - 18","Stimulasi Umur 15 - 18 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Bahasa.Bahasa15"));
        list.add(new ListStimulus("18 - 24","Stimulasi Umur 18 - 24 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Bahasa.Bahasa18"));
        list.add(new ListStimulus("24 - 36","Stimulasi Umur 24 - 36 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Bahasa.Bahasa24"));
        list.add(new ListStimulus("36 - 48","Stimulasi Umur 36 - 48 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Bahasa.Bahasa36"));
        list.add(new ListStimulus("48 - 60","Stimulasi Umur 48 - 60 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Bahasa.Bahasa48"));
        list.add(new ListStimulus("60 - 72","Stimulasi Umur 60 - 72 Bulan",
                "com.example.asyrofiabdusani.tumbangapp.Stimulasi.Bahasa.Bahasa60"));
    }
